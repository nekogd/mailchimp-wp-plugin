...
?>
<div id="nekomc-admin" class="wrap nekomc-settings">
	...
	<div class="row">
		...
		<div class="main-content col col-4">
			...
			<form action="<?php echo admin_url( 'options.php' ); ?>" method="post">
				<?php settings_fields( 'nekomc_settings' ); ?>
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td>
							<input type="text" class="widefat" placeholder="<?php echo esc_html__( 'Your Mailchimp API key', 'mailchimp-for-wp' ); ?>" id="mailchimp_api_key" name="nekomc[api_key]" value="<?php echo esc_attr( $obfuscated_api_key ); ?>" <?php echo defined( 'NEKOMC_API_KEY' ) ? 'readonly="readonly"' : ''; ?> />
							<p class="help">
							...
							<?php
							if ( defined( 'NEKOMC_API_KEY' ) ) {
								echo '<p class="help">', wp_kses( __( 'You defined your Mailchimp API key using the <code>NEKOMC_API_KEY</code> constant.', 'mailchimp-for-wp' ), array( 'code' => array() ) ), '</p>';
							}
							?>
						</td>
